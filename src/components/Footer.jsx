      ...
      <div className="glass rounded-2xl border border-violet-500/10 p-8 mx-2 md:mx-4">
        ...
        <div className="disclaimer flex flex-col justify-center items-center gap-4">
          <p className="text-sm text-center text-gray-400 max-w-2xl">
            Kamanime does not store any files on our servers. We only provide links to media hosted on third-party services.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4 text-sm">
            ...
            <Link to="/animes/movie" className="text-gray-400 hover:text-primary transition-colors">
              Movies
            </Link>
            <Link to="/animes/tv" className="text-gray-400 hover:text-primary transition-colors">
              TV Series
            </Link>
            <Link to="/animes/most-popular" className="text-gray-400 hover:text-primary transition-colors">
              Popular
            </Link>
          </div>
        </div>
